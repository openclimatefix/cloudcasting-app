...
- `SATELLITE_ICECHUNK_PATH`: The path to the satellite archive in icechunk formast
- `S3_REGION`: The AWS region of the bucket the satellite icechunk store is in. Unused if
